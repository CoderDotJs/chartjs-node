...
(0, mocha_1.describe)(_1.ChartJSNodeCanvas.name, () => {
    ...
    (0, mocha_1.it)('works with render to buffer', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({ width, height, chartCallback, backgroundColour: 'white' });
        const actual = yield chartJSNodeCanvas.renderToBuffer(configuration);
        yield assertImage(actual, 'render-to-buffer');
    }));
    (0, mocha_1.it)('works with render to data url', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({ width, height, chartCallback, backgroundColour: 'white' });
        const actual = yield chartJSNodeCanvas.renderToDataURL(configuration);
        const extension = '.txt';
        ...
        const expected = yield fs_1.promises.readFile(expectedDataPath, 'utf8');
        // const result = actual === expected;
        const compareData = yield compareImages(actual, expected, { output: { useCrossOrigin: false } });
        ...
        if (result) {
            ...
            yield fs_1.promises.writeFile(actualDataPath, actual);
            ...
            yield fs_1.promises.writeFile(compareDataPath, compare);
            const diffPng = compareData.getBuffer();
            yield writeDiff(expectedDataPath.replace(fileNameWithExtension, fileName + '-diff' + extension), diffPng);
    ...
    (0, mocha_1.it)('works with render to stream', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({ width, height, chartCallback, backgroundColour: 'white' });
        const stream = chartJSNodeCanvas.renderToStream(configuration);
        const actual = yield streamToBuffer(stream);
        yield assertImage(actual, 'render-to-stream');
    }));
    (0, mocha_1.it)('works with registering plugin', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        ...
        const actual = yield chartJSNodeCanvas.renderToBuffer({
            type: 'bar',
            data: {
        ...
        yield assertImage(actual, 'chartjs-plugin-annotation');
    }));
    (0, mocha_1.it)('works with self registering plugin', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({
            width, height, backgroundColour: 'white', plugins: {
                requireLegacy: [
        ...
        yield assertImage(actual, 'chartjs-plugin-datalabels');
    }));
    ...
    // });
    (0, mocha_1.it)('works with custom font', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({
        ...
        yield assertImage(actual, 'font');
    }));
    (0, mocha_1.it)('works without background color', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const chartJSNodeCanvas = new _1.ChartJSNodeCanvas({ width, height, chartCallback });
        const actual = yield chartJSNodeCanvas.renderToBuffer(configuration);
        yield assertImage(actual, 'no-background-color');
    }));
    ...
    */
    function assertImage(actual, fileName) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const extension = '.png';
            const fileNameWithExtension = fileName + extension;
            const testDataPath = (0, path_1.join)(process.cwd(), 'testData', (0, os_1.platform)(), fileNameWithExtension);
            const exists = yield pathExists(testDataPath);
            if (!exists) {
                console.error(`Warning: expected image path does not exist!, creating '${testDataPath}'`);
                yield fs_1.promises.writeFile(testDataPath, actual, 'base64');
                return;
            }
            const expected = yield fs_1.promises.readFile(testDataPath);
            const compareData = yield compareImages(actual, expected);
            ...
            if (result) {
                yield fs_1.promises.writeFile(testDataPath.replace(fileNameWithExtension, fileName + '-actual' + extension), actual);
                const diffPng = compareData.getBuffer();
                yield writeDiff(testDataPath.replace(fileNameWithExtension, fileName + '-diff' + extension), diffPng);
                throw new assert_1.AssertionError({
