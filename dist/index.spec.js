...
(0, mocha_1.describe)(_1.ChartJSNodeCanvas.name, () => {
    ...
    function createSUT(type, plugins) {
        ...
        return new _1.ChartJSNodeCanvas({
            width,
            height,
            chartCallback,
            type,
        ...
        (0, mocha_1.describe)(`given canvasType 'undefined'`, () => {
            ...
            mimeTypes.forEach((mimeType) => {
                (0, mocha_1.describe)(`given mimeType '${mimeType}'`, () => {
                    (0, mocha_1.it)("renders data url", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                        const chartJSNodeCanvas = createSUT(canvasType);
                        const dataUrl = yield chartJSNodeCanvas.renderToDataURL(configuration, mimeType);
                        assert_1.default.equal(dataUrl.startsWith(`data:${mimeType};base64,`), true);
                    }));
                    (0, mocha_1.it)("renders data url in parallel", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                        const chartJSNodeCanvas = createSUT(canvasType);
                        const promises = Array(3)
                            .fill(undefined)
                            .map(() => chartJSNodeCanvas.renderToDataURL(configuration, mimeType));
                        const dataUrls = yield Promise.all(promises);
                ...
                (0, mocha_1.describe)(`given mimeType '${mimeType}'`, () => {
                    ...
                    (0, mocha_1.it)("renders data url in parallel", () => {
                        ...
                        const dataUrls = Array(3)
                            .fill(undefined)
                            .map(() => chartJSNodeCanvas.renderToDataURLSync(configuration, mimeType));
                        dataUrls.forEach((dataUrl) => assert_1.default.equal(dataUrl.startsWith(`data:${mimeType};base64,`), true));
                    });
                });
            });
        ...
        (0, mocha_1.describe)(`given canvasType 'undefined'`, () => {
            ...
            mimeTypes.forEach((mimeType) => {
                (0, mocha_1.describe)(`given extended mimeType '${mimeType}'`, () => {
                    (0, mocha_1.it)("renders chart", () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
                        const chartJSNodeCanvas = createSUT(canvasType);
                        const image = yield chartJSNodeCanvas.renderToBuffer(configuration, mimeType);
